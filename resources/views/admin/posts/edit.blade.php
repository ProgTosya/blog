                        ...
                        <div class="form-group w-50 mt-3">
                            <div class="input-group">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="exampleInputFile">Изменить превью</label>
                                </div>
                            ...
                            <div class="form-group w-50 mt-3">
                                <div class="input-group">
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label" for="exampleInputFile">Изменить главное изображение</label>
                                    </div>
                                    <div class="input-group-append">
                                        <span class="input-group-text">Загрузка</span>
                                    </div>
